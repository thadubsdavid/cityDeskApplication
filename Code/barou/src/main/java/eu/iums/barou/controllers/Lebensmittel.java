...
public class Lebensmittel {
    ...
    public void buttonPressedRooute(ActionEvent actionEvent) throws IOException {
    ...
    public void buttonPressedLebensmittel(ActionEvent actionEvent) throws IOException {
        Parent parent = FXMLLoader.load(getClass().getResource("../Shopping.fxml"));
        Scene scene = new Scene(parent);
